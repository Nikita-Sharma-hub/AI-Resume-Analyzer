...
export function Toast({ type = 'info', message, onClose, autoClose = true, duration = 5000 }) {
  ...
  return (
    <div
      className={cn(
        'fixed top-4 right-4 z-50 max-w-sm w-full bg-white dark:bg-gray-800 rounded-lg shadow-lg border transition-all duration-300 transform',
        toastVariants[type],
      ...
      <div className="p-4">
        <div className="flex items-start">
          ...
          <div className="ml-4 shrink-0 flex">
            <button
              className="inline-flex text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 focus:outline-none focus:text-gray-600 dark:focus:text-gray-200 transition-colors"
              onClick={handleClose}
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
